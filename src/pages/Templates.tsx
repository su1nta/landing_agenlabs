    ...
    return (
        <>
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-20 flex gap-2 h-auto mx-auto justify-between items-start">
                    <div className="flex flex-col gap-3 max-w-sm text-left justify-start">
                        <h2 className="text-xl text-neutral-700 font-semibold">Foxtrot</h2>
                        <p className="text-sm text-neutral-600">Foxtrot is a SaaS marketing template that has a modern design with a pinch of class.</p>
